...
if (class_exists('ConsoleColor_Sniffs_Commenting_FileCommentSniff', true) === false) {
	$error = 'Class ConsoleColor_Sniffs_Commenting_FileCommentSniff not found';
	throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ConsoleColor_Sniffs_Commenting_ClassCommentSniff extends ConsoleColor_Sniffs_Commenting_FileCommentSniff {
